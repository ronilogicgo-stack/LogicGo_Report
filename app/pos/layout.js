        ...
        <nav className="bg-gradient-to-r from-emerald-600 to-teal-600 shadow-md px-4 sm:px-6 py-3 sm:py-4 flex flex-wrap items-center justify-between gap-3">
          <div className="flex flex-wrap items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-white truncate">POS · {name}</span>
              {!canEdit && (
            ...
            <Link href="/pos" className="text-sm text-emerald-100 hover:text-white">
              Dashboard
            </Link>
            <Link href="/pos/products" className="text-sm text-emerald-100 hover:text-white">
              Products
            </Link>
            <Link href="/pos/traders" className="text-sm text-emerald-100 hover:text-white">
              Traders
            </Link>
          ...
          <button
            ...
            className="text-sm text-emerald-100 hover:text-white whitespace-nowrap"
          >
            Log out
          </button>
        </nav>
